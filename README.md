...
You do not need to submit anything for Problems 1a or 3a.
...
choose to collaborate, please list your collaborators at the top of your `hw3-written.pdf` file. If you choose to use ChatGPT or a similar AI assistant to help you with this assignment in any way, please include a file called `hw3-chatgpt-logs.txt` with a full transcript of all prompts and responses used for this assignment. Your use of AI assistants cannot involve generating images or any other content that cannot be included in a .txt file.
...
Please refer to their websites for installation instructions. All libraries are available on SCC's `academic-ml/spring-2026` module.

## Submission

For your submission, please upload the following files to [Gradescope](https://www.gradescope.com) under "HW 3 Code Problems":
...
Please upload the following file to Gradescope under "HW 3 Written Problems":
...
|-------------------------------------|------------------|--------|
| 1b: Understand BERT Inputs          | Written          | 2      |
| 1c: Understand BERT Hyperparameters | Written          | 2      |
| 1d: Prepare Dataset                 | Code             | 2      |
...
* at least .4 points if a good-faith effort (according to Yulu's judgement) has been made to answer the question
